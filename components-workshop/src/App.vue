<template>
  <div id="app">
    ...
    <div class="main">
      <app-navigation @navigate="navigationHandler($event)" 
      :navItems="tutorials.technologies" 
      :selected-index="selectedechnologieInx"
      ></app-navigation>
...
//import AppLogin from "./components/core/Login.vue";
//import AppRegister from "./components/core/Register.vue";
import AppCreateSubject from "./components/core/CreateSubject.vue";
...
export default {
  ...
  data() {
    return {
      tutorials,
      selectedechnologieInx: 0
    };
  },
  methods: {
      navigationHandler(inx) {
          this.selectedechnologieInx = inx;
      }
  },
  computed: {
      subjects() {
          return this.tutorials.technologies[this.selectedechnologieInx].subjects;
      }
  }
};
</script>
